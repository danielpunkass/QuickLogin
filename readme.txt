=== QuickLogin ===
Contributors: redsweater, gluten, stephenhowells
...
QuickLogin will now interpret a press of the trigger key (ESC) when already logged in as implying that the user wants to jump directly to the admin panel.
